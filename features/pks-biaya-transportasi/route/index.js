...
router.post("/ajukan-ke-bpdp/:id_biaya_transportasi", ajukanKeBpdp);
router.post(
  "/ajukan-ke-verifikator",
  uploadConfigs
    .custom(
      "verifikasi_pengajuan_biaya_transportasi", // nama folder
...
router.post(
  "/staff-beasiswa/:id_biaya_transportasi",
  uploadConfigs.ttd_staff_beasiswa.single("ttd"),
  staffBeasiswa,
);
router.get("/generate-rab/:id_biaya_transportasi", generateRab);
...
router.post(
  "/verifikator-pjk/:id_biaya_transportasi",
  uploadConfigs.ttd_staff_beasiswa.single("ttd"),
  verifikatorPjk,
);

router.get("/tagihan-tahap-lalu/:id_biaya_transportasi", getTagihanTahapLalu);

router.get("/log/:id_biaya_transportasi", getLog);
